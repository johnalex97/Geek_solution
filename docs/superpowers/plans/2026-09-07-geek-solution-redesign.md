...
- El formulario usa `VITE_CONTACT_FORM_ENDPOINT` y debe funcionar en la imagen Docker mediante argumento de compilación.
...
- Consumes: `VITE_CONTACT_FORM_ENDPOINT` compiled by Vite.
